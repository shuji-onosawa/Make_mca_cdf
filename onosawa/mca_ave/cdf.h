...
*   V3.7  21-Jun-04, M Liu      Added a new error, NOT_A_CDF_OR_SUPPORTED.
*
******************************************************************************/
...
#define NOT_A_CDF_OR_NOT_SUPPORTED      ((CDFstatus) (-2112))
...
VISIBLE_PREFIX void EPOCH16breakdown PROTOARGs((
  double epoch[], long *year, long *month, long *day, long *hour, long *minute,
  long *second, long *msec, long *usec, long *nsec, long *psec
));
